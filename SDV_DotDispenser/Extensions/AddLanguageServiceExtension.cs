        ...
        public static IHostBuilder AddLanguageService(this IHostBuilder hostBuilder)
        {
            hostBuilder.ConfigureServices((hostContext, services) =>
            {
                services.AddSingleton<ILanguageService>(s => {
                    ...
                    {
                        new VietnameseLanguage($"/SDV_DotDispenser;component/Resource/Language/VietnameseLanguage.xaml"),
                        new EnglishLanguage($"/SDV_DotDispenser;component/Resource/Language/EnglishLanguage.xaml"),
                        new KoreanLanguage($"/SDV_DotDispenser;component/Resource/Language/KoreanLanguage.xaml")
                    };
