        ...
        public static IHostBuilder AddLanguageService(this IHostBuilder hostBuilder)
        {
            hostBuilder.ConfigureServices((hostContext, services) =>
            {
                services.AddSingleton<ILanguageService>(s => {
                    ...
                    {
                        new VietnameseLanguage($"/SDV_DemoEQ;component/Resource/Language/VietnameseLanguage.xaml"),
                        new EnglishLanguage($"/SDV_DemoEQ;component/Resource/Language/EnglishLanguage.xaml"),
                        new KoreanLanguage($"/SDV_DemoEQ;component/Resource/Language/KoreanLanguage.xaml")
                    };
