...
{
    /// <summary>
    /// Interaction logic for AdditionalMoldingView.xaml
    /// </summary>
    public partial class AdditionalMoldingView : UserControl
    {
        public AdditionalMoldingView()
        {
            InitializeComponent();
        }
        ...
        {
            if (this.DataContext is AdditionalMoldingViewModel dataContext)
            {
                LoadRecipe(dataContext.RecipeList.AdditionalMolding_Recipe);
            }
        }
    }
}
