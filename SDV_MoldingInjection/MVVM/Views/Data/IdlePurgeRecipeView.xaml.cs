...
{
    /// <summary>
    /// Interaction logic for IdlePurgeRecipeView.xaml
    /// </summary>
    public partial class IdlePurgeRecipeView : UserControl
    {
        public IdlePurgeRecipeView()
        {
            InitializeComponent();
        }
        ...
        {
            if (this.DataContext is IdlePurgeViewModel dataContext)
            {
                LoadRecipe(dataContext.RecipeList.IdlePurgeRecipe);
            }
        }
    }
}
