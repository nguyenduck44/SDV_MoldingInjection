...
{
    /// <summary>
    /// Interaction logic for InjectTimeView.xaml
    /// </summary>
    public partial class InjectTimeView : UserControl
    {
        public InjectTimeView()
        {
            InitializeComponent();
        }
        ...
        {
            if (this.DataContext is InjectTimeViewModel dataContext)
            {
                LoadRecipe(dataContext.RecipeList.InjectTimeRecipe);
            }
        }
    }
}
