...
{
    /// <summary>
    /// Interaction logic for CDASettingView.xaml
    /// </summary>
    public partial class CDASettingView : UserControl
    {
        public CDASettingView()
        {
            InitializeComponent();
        }
        ...
        {
            if (this.DataContext is CDASettingViewModel dataContext)
            {
                LoadRecipe(dataContext.RecipeList.CDASettingRecipe);
            }
        }
    }
}
